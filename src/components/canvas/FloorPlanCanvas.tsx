    ...
    return roomFixtures.map((fix) => {
      ...
      return (
        ...
        >
          ...
          {fix.type === 'toilet' && (
            <g stroke="#7f5539" strokeWidth={1.2}>
              <rect x={3} y={2} width={w - 6} height={8} rx={2} fill="#ffffff" />
              <ellipse cx={w / 2} cy={h - 12} rx={w / 2 - 4} ry={h / 2 - 6} fill="#ffffff" />
            </g>
          )}
          ...
          {fix.type === 'shower' && (
            <g stroke="#7f5539" strokeWidth={1}>
              <circle cx={w / 2} cy={h / 2} r={6} fill="#e0f2fe" stroke="#0284c7" />
              <line x1={2} y1={2} x2={w - 2} y2={h - 2} stroke="#cbd5e1" strokeDasharray="2 2" />
            </g>
          )}
